...
\createposition{
    ...
    description={
% Progressed from Software Engineer to Senior Software Engineer to Principal Software Engineer over a 5 years period. 
Technical Lead of 5 people team that improved ROS~2 performance, reducing CPU usage by over 70\%, and integrated it on Roomba\texttrademark\, robots.
Software Architect for floorcare robots and designed the Create\texttrademark 3 navigation application.
Improved accuracy of dead-reckoning through data synchronization and developed libraries for behavior trees.
    }
}
...
\dateitem{2022}{iRobot STEM Star}
