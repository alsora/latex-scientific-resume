...
Technical Lead of 5 people team that integrated ROS~2 on Roomba\texttrademark. Software Architect for floorcare and educational robots. Developing robotics applications, estimation algorithms and behaviors.
    }
}
...
\createposition{
    ...
    description={
Developed Machine Learning, Statistics and Neural Network techniques for Natural Language Processing. Implemented pipelines for lyrics processing. Dataset collection and features engineering.
    }
}
...
\createposition{
    ...
    description={
Master Thesis student in the Mobile Robotics Navigation team. Developed algorithms for the exploration of industrial environments and active SLAM. Published the work as multiple patents and a paper.
    }
}
...
Study Emphases: \emph{Mobile Robotics, Computer Vision, Machine Learning}
    }
}
...
Study Emphases: \emph{Mathematics, Physics, Control Theory}
    }
}
