...
\createposition{
    ...
    description={
\begin{descitemize}
    \item Itemized position description...
    \item Another fancy item
    \item The last fancy item that closes this itemize environment, nicely included and understandable, it contains all your useful information.
\end{descitemize}
    }
}
