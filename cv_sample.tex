...
\raisebox{-0.1em}{\includegraphics[width=1em]{images/flag/italy.png}} ~ {\bf Italian}: ~ Mothertongue\\
\raisebox{-0.1em}{\includegraphics[width=1em]{images/flag/united-states.png}} ~ {\bf English}: ~ Proficient\\
\raisebox{-0.1em}{\includegraphics[width=1em]{images/flag/china.png}} ~ {\bf Chinese:} ~ Basic spoken
...
\createposition{
	...
	Dissertation: \emph{``New Frontiers: Robots Eating Blackberries''}  $~|~$ {Advisor: Prof. Name \textsc{Surname}}\\
